...
/**Curso: HMTL5 - Pildoras Informáticas - API File VI
 * Origin: Capitulo59.html ==> Moviéndo directorios
 */
...
directorioDestino = document.getElementById("directorio-destino");
...
// Borramos los cuadros de texto que hemos introducido
    document.getElementById("archivo-origen").value = "";
    document.getElementById("directorio-destino").value = "";
    mostrarArchivo();
}
...
function modificarArchivo() {
    ...
    espacio.getFile(archivoOrigen, null, function(archivo) {
        espacio.getDirectory(destino, null, function(directorio) {
            archivo.moveTo(directorio, null, exitoMover, errores);
        }, errores);
    }, errores);
}
